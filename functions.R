...
sk_plot.xyzh <-function(x_sk, y_sk, z_sk, h_k,path_output ){
  ...
  plot(x_sk[,2], x_sk[,4], ylim = c(min.k, max.k), xlab = 'Time (hours)', ylab = 'Kurtosis', type = 'p', main = paste('Kurtosis', sep=''), col="blue", pch =1, cex = 2, sub = 'x: blue     y: red     z: green     h:black' )
